data {
  ...
  vector[2] zero;
  array[J,2] int sample;           // sample sizes (placeholder for prior predictive)
...
model {
  ...
  beta ~ normal(0, 0.5);             // Prior for subgroup effect (weakly informative)
...
generated quantities {
  ...
  array[J,2] int y_rep;                // Prior predictive samples
